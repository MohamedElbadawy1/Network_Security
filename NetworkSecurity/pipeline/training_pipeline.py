...
class TrainingPipeline:
    ...
    ## Sync the local artifact with s3 bucket
...
##            raise NetworkSecurityException(e, sys)
    ...
    ## Sync the local final_model with s3 bucket
##    def sync_saved_model_dir_to_s3(self):
##        try:
##            aws_bucket_url = f"s3://{TRAINING_BUCKET_NAME}/final_models/{self.train_pipeline_config.timestamp}"
